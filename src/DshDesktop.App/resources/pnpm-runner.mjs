// DSH Desktop 自带的 pnpm 运行器垫片（原样 vendored，勿手改逻辑）。
// 来源：dsh-desktop-market-installer@0.1.0 的 pnpm-runner.mjs，源 md5 071621bf4fda1ad1c14c95e8fbb2c2ed；
// 除本头部注释外与上游逐字节一致（升级上游时用 md5 比对 body 行）。
// 为什么需要它：<dshHome>\.desktop-bin\pnpm.cmd 指向本文件 —— 工作台内的 dsh-market 与宿主自己的
// 安装器都按【名字】调用 pnpm，遂都经此 runner：它在每次 pnpm 运行前把 dsh.desktop.generationProjection
// 里的插件从 dependencies + pnpm.overrides 临时摘除、跑完恢复（悬空 link: 会被重建为悬空 junction，
// 打坏 profile），并提供 Windows 锁定改名的重试 / 旁置恢复。
/**
